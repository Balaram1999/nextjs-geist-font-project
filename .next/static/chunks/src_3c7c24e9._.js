...
const UserProvider = ({ children })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UserProvider.useEffect": ()=>{
            const savedUser = localStorage.getItem('quizkaro_user');
            if (savedUser) {
                const userData = JSON.parse(savedUser);
                setUser(userData);
                setIsAuthenticated(true);
                // Check if it's a new day and reset daily limits
                const lastLoginDate = localStorage.getItem('quizkaro_last_login');
                const today = new Date().toDateString();
                if (lastLoginDate !== today) {
                    setUser({
                        "UserProvider.useEffect": (prev)=>prev ? {
                                ...prev,
                                hasCompletedDailyQuiz: false,
                                hasUsedSpinToWin: false
                            } : null
                    }["UserProvider.useEffect"]);
                    localStorage.setItem('quizkaro_last_login', today);
                }
            }
        }
    }["UserProvider.useEffect"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UserProvider.useEffect": ()=>{
            if (user) {
                localStorage.setItem('quizkaro_user', JSON.stringify(user));
            }
        }
    }["UserProvider.useEffect"], [
        user
    ...
    const generateReferralCode = (mobile)=>{
        return `QK${mobile.slice(-4)}${Math.random().toString(36).substring(2, 6).toUpperCase()}`;
    };
    const login = (mobile, name)=>{
        const newUser = {
        ...
        setUser(newUser);
        setIsAuthenticated(true);
        localStorage.setItem('quizkaro_last_login', new Date().toDateString());
    };
    const logout = ()=>{
        setUser(null);
        setIsAuthenticated(false);
        localStorage.removeItem('quizkaro_user');
        localStorage.removeItem('quizkaro_last_login');
    };
    ...
    const markQuizCompleted = ()=>{
        setUser((prev)=>prev ? {
                ...prev,
                hasCompletedDailyQuiz: true
            } : null);
    };
    const markSpinUsed = ()=>{
        setUser((prev)=>prev ? {
                ...prev,
                hasUsedSpinToWin: true
            } : null);
    };
...
_s1(UserProvider, "Es9VRuubQSTt9E+Juy2JGCCc0ro=");
_c = UserProvider;
var _c;
...
const Header = ()=>{
    _s();
    const { user, isAuthenticated, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$UserContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"])();
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "bg-yellow-400 text-yellow-900 px-3 py-1 rounded-full font-semibold text-sm",
                                    children: [
                                        "🪙 ",
                                        user?.coins || 0
                                    ]
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                variant: pathname === '/referral' ? 'secondary' : 'ghost',
                                size: "sm",
...
_s(Header, "dx1sAJjbvkxXtrX9Yqq8DHWSlAs=", false, function() {
    return [
...
//# sourceMappingURL=src_3c7c24e9._.js.map